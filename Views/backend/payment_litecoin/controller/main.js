...
Ext.define('Shopware.apps.PaymentLiteCoin.controller.Main', {
    extend: 'Enlight.app.Controller',

    refs: [
        { ref: 'window', selector: 'litecoin-main-window' },
        { ref: 'detail', selector: 'litecoin-main-detail' },
        { ref: 'list', selector: 'litecoin-main-list' },
        { ref: 'shopCombo', selector: 'litecoin-main-list [name=shopId]' }
    ],
    ...
    snippets:  {
        error: {
            ...
            10007: '{s name="invalidTransaction"}The transaction is not valid or not known to LiteCoin, not paid yet{/s}'
        }
    },
    ...
    init: function () {
        ...
        me.control({
            ...
            'litecoin-main-list [name=searchfield]': {
    ...
    onSelectionChange: function(table, records) {
        ...
        if(record) {
            ...
            me.detailStore.load({
                ...
                filters : [{
                    property: 'litecoin_address',
                    value: record.get('litecoin_address')
                }],
     ...
     * @param code
     */
    showLiteCoinErrorMessage: function(title, error, code) {
        var me = this,
            message;
    ...
    onLoadDetail: function(records, operation, success) {
        ...
        if(!detail) {
            ...
            if (!success) {
                ...
                me.showLiteCoinErrorMessage(me.snippets.error.title, error, errorCode);
            }
            return;
        }
        formPanel.setLoading(false);
