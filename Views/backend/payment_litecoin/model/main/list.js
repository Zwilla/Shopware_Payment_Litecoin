...
Ext.define('Shopware.apps.PaymentLiteCoin.model.main.List', {
	extend: 'Ext.data.Model',
	fields: [
		{ name: 'id', type: 'int' },
		{ name: 'userId',  type: 'string' },
		{ name: 'litecoin_address', type: 'string' },
		{ name: 'valueInLTC', type: 'float' },
		{ name: 'total_paid_in_ltc', type: 'float' },
		{ name: 'ltcStatus', type: 'string' },
