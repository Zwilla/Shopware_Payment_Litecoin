...
Ext.define('Shopware.apps.PaymentLiteCoin.view.main.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.litecoin-main-list',
    ...
    getColumns: function() {
        ...
        return [{
            ...
            text: '{s name=list/columns/litecoin_address_text}LiteCoin address{/s}',
            flex: 3,
            dataIndex: 'litecoin_address'
        },{
            text: '{s name=list/columns/value_in_ltc}Value in LTC{/s}',
            flex: 2,
            align: 'right',
            dataIndex: 'valueInLTC'
        },{
            text: '{s name=list/columns/total_paid_in_ltc}Paid in LTC{/s}',
            flex: 2,
            align: 'right',
            dataIndex: 'total_paid_in_ltc'
        },{
            text: '{s name=list/columns/litecoin_status}LiteCoin Status{/s}',
            flex: 2,
            dataIndex: 'ltcStatus'
        },{
