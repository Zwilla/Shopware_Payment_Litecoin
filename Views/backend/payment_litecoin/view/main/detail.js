...
Ext.define('Shopware.apps.PaymentLiteCoin.view.main.Detail', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.litecoin-main-detail',
    ...
    getColumns: function() {
        ...
        return [{
            ...
            text: '{s name=detail/columns/value_in_ltc_text}Value in LTC{/s}',
            flex: 2,
            dataIndex: 'value_in_ltc'
        }];
    }
});